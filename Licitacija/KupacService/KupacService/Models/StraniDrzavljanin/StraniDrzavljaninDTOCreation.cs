...
{
    /// <summary>
    /// DTO za kreiranje ovlašćenog lica koje je strani državljanin.
    /// </summary>
    public class StraniDrzavljaninDTOCreation : OvlascenoLiceDTOCreation, IValidatableObject
    {
        /// <summary>
        ...
        public new IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            if (!IsValidBrojPasosa(BrojPasosa))
            {
                yield return new ValidationResult(
                    ...
                    new[] { "StraniDrzavljaninDTOCreation" });
            }
